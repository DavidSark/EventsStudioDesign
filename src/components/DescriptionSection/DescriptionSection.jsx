                ...
                <div className="container-desc">
                    ...
                    <div className="container-desc-text-parent">
                        <div className="container-desc-text">
                            ...
                            <h2>Qui suis-je ?</h2>
                            <p>Bienvenue dans mon univers de la décoration ! Je suis Mariam, et votre partenaire idéal pour donner vie à votre imaginaine et créer des souvenirs inoubliables lors d'événements spéciaux.</p> <br /><br />
